...
function cacheFunction(cb) {
  ...
  //   } else {
  //     // guardando el resultado (si no existia) y devolverlo
...
// const aux = cacheFunction(permitido)
...
function getNombre() {
  return this.nombre; // Esta el "this" en el contexto global, o sea, apunta al Global
}
...
console.log(crearCadena.bind(this, "*", "*"));
